...
| ------------- | ------------- | -------------                                     | -------------                           | ------------- |------------- |
| 01            | 07.10.2025    | Вводная лекция. Кросс-валидация, дилемма смещения-разброса | Вводное занятие. Кросс-валидация | seminar01: реализация эвристического метода для распознавания рукописных цифр| [Лекция 01 на youtube](https://youtu.be/G7RzMBGGmBc)|
|               | 14.19.2025    | Занятия не будет |   |  ||
| 02            | 21.10.2025    | Вероятностный подход к классификации | Разбор первого задания | seminar02: реализация наивного байесовского классификатора|[Лекция 02 на youtube](https://youtu.be/iowdZXnmye8)|
| 03            | 28.10.2025    | Метод ближайших соседей | Методы поиска ближайших соседей | seminar03: настройка метода ближайших соседей|[Лекция 03(2024) на youtube](https://youtu.be/wkqoWtDUxWU)|
|               | 04.11.2025    | Занятия не будет |   |  ||
| 04            | 11.11.2025    | Линейная регрессия | Метрики качества |  |[Лекция 04(2024) на youtube](https://youtu.be/wZcguLtbnMc)|
| 05            | 18.11.2025    | Линейные классификаторы. Обучение моделей | Методы восстановления пропущенных значений. Категориальные признаки | seminar05: методы препроцессинга данных, подсчет метрик; competition01: выдача первого соревнования| [Лекция 05(2024) на youtube](https://youtu.be/FIcZsElOmH8)|
| 06            | 25.11.2025    | Машины опорных векторов |  Машины опорных векторов на практике |  |[Лекция 06(2024) на youtube](https://youtu.be/-CJxXDPRXVo)|
| 07            | 02.12.2025    | Решающие деревья. Случайный лес | |  |[Лекция 07(2024) на youtube](https://youtu.be/TPLbx_1ypq4)|
| 08            | 09.12.2025   | Бустинг | Ансамблирвание | Разбор соревнования |[Лекция 08(2024) на youtube](https://youtu.be/-yN3MQ15J6c)|
| 09            | 16.12.2025    | Методы уменьшения размерности | Разбор домашних работ  |  |[Лекция 09(2024) на youtube](https://youtu.be/UIarVdKfV7E)|
